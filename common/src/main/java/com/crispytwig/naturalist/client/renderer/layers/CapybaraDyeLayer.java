...
public class CapybaraDyeLayer extends DyeLayer<Capybara, HierarchicalModel<Capybara>> {
    ...
    public CapybaraDyeLayer(RenderLayerParent<Capybara, HierarchicalModel<Capybara>> parent) {
