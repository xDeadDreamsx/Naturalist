...
public class OstrichDyeOverlayRenderLayer extends DyeOverlayRenderLayer<Ostrich, HierarchicalModel<Ostrich>> {
    private final EnumMap<DyeColor, ResourceLocation> babyTextures = new EnumMap<>(DyeColor.class);

    public OstrichDyeOverlayRenderLayer(RenderLayerParent<Ostrich, HierarchicalModel<Ostrich>> parent) {
