...
public class Deer extends NaturalistAnimal implements DataDrivenVariantAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new AvoidEntityGoal<>(this, Animal.class, 10.0F, 1.5D, 2.0D, livingEntity -> livingEntity.getType().builtInRegistryHolder().is(NaturalistTags.EntityTypes.DEER_PREDATORS)));
