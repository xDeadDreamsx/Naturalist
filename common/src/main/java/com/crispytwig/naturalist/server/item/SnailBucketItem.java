...
public class SnailBucketItem extends NaturalistBucketItem {
    public SnailBucketItem(EntityType<?> entityType, Fluid content, SoundEvent emptySound, Properties properties) {
