...
public class NaturalistSoundEvents {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> ANGLERFISH_IDLE = register("entity.anglerfish.idle");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANGLERFISH_SWIM = register("entity.anglerfish.swim");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANGLERFISH_HURT = register("entity.anglerfish.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANGLERFISH_DEATH = register("entity.anglerfish.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> WHALE_AMBIENT = register("entity.whale.ambient");
    public static final DeferredHolder<SoundEvent, SoundEvent> WHALE_HURT = register("entity.whale.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> WHALE_DEATH = register("entity.whale.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> WHALE_BLOWHOLE = register("entity.whale.blowhole");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANT_AMBIENT = register("entity.ant.ambient");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANT_HURT = register("entity.ant.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANT_DEATH = register("entity.ant.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> ANT_STEP = register("entity.ant.step");
    public static final DeferredHolder<SoundEvent, SoundEvent> MOLE_AMBIENT = register("entity.mole.ambient");
    public static final DeferredHolder<SoundEvent, SoundEvent> MOLE_HURT = register("entity.mole.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> MOLE_DEATH = register("entity.mole.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> MOLE_DIG_DOWN = register("entity.mole.dig_down");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> BLACK_BEAR_AMBIENT = register("entity.black_bear.ambient");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLACK_BEAR_HURT = register("entity.black_bear.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLACK_BEAR_DEATH = register("entity.black_bear.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLACK_BEAR_SLEEP = register("entity.black_bear.sleep");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> BLOBFISH_FLOP = register("entity.blobfish.flop");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLOBFISH_SWIM = register("entity.blobfish.swim");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLOBFISH_HURT = register("entity.blobfish.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> BLOBFISH_DEATH = register("entity.blobfish.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> PIRANHA_FLOP = register("entity.piranha.flop");
    public static final DeferredHolder<SoundEvent, SoundEvent> PIRANHA_IDLE = register("entity.piranha.idle");
    public static final DeferredHolder<SoundEvent, SoundEvent> PIRANHA_HURT = register("entity.piranha.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> PIRANHA_DEATH = register("entity.piranha.death");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> CLAM_LAUNCH = register("entity.clam.launch");
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAB_AMBIENT = register("entity.crab.ambient");
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAB_HURT = register("entity.crab.hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAB_DEATH = register("entity.crab.death");
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAB_STEP = register("entity.crab.step");
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAB_PINCER = register("entity.crab.pincer");
